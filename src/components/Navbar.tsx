    ...
    <nav className=" p-4 relative">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex md:items-center space-x-6">
          ...
          <Link href="#" className="text-gray-300 hover:text-white">Register</Link>
      ...
      <div className={`absolute top-16 left-0 w-full bg-custom-dark pb-5 px-5 rounded-b-lg ${isOpen ? 'block' : 'hidden'}`}>
        ...
        <CustomButton text="Get your Cerberus" href="/get-cerberus" className="block w-full text-center my-2" />
      </div>
    </nav>
  );
};
